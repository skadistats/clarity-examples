...
public @interface OnEntityDying {
    ...
    final class Event extends skadistats.clarity.event.Event<OnEntityDying> {
        private final Listener[] typedListeners;

        public Event(Runner runner, Class<OnEntityDying> eventType, Set<EventListener<OnEntityDying>> listeners) {
