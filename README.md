...
You can find an executable example of the example above under [skadistats.clarity.examples.allchat.Main.java](./examples/src/main/java/skadistats/clarity/examples/allchat/Main.java).
...
You can find it under [skadistats.clarity.examples.combatlog.Main.java](./examples/src/main/java/skadistats/clarity/examples/combatlog/Main.java).
Follow the instructions above to build and run it with
...
You can find it under [skadistats.clarity.examples.matchend.Main.java](./examples/src/main/java/skadistats/clarity/examples/matchend/Main.java).
Follow the instructions above to build and run it with
...
You can find the processor under [skadistats.clarity.examples.lifestate.SpawnsAndDeaths.java](./examples/src/main/java/skadistats/clarity/examples/lifestate/SpawnsAndDeaths.java),
and the class that uses it under [skadistats.clarity.examples.lifestate.Main.java](./examples/src/main/java/skadistats/clarity/examples/lifestate/Main.java). 
...
You can find the processor under [skadistats.clarity.examples.cooldowns.Cooldowns.java](./examples/src/main/java/skadistats/clarity/examples/cooldowns/Cooldowns.java),
and the class that uses it under [skadistats.clarity.examples.cooldowns.Main.java](./examples/src/main/java/skadistats/clarity/examples/cooldowns/Main.java).
...
You can find this example under [skadistats.clarity.examples.info.Main.java](./examples/src/main/java/skadistats/clarity/examples/info/Main.java).
Follow the instructions above to build and run it with
...
You can find it under [skadistats.clarity.examples.dev.dtinspector.Main.java](./dev/src/main/java/skadistats/clarity/examples/dev/dtinspector/Main.java).
Follow the instructions above to build and run it with
...
Another example for creating your own event provider is [a provider for spawn / death events](./examples/src/main/java/skadistats/clarity/examples/lifestate/SpawnsAndDeaths.java).
